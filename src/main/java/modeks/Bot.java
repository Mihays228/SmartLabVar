...
public class Bot extends TelegramLongPollingBot {
    //TODO Кнопки и клавиатуры для меню
...
//                        System.out.println("\\U+1F600" + strElement + "\\U+1F600");
                        if (strElement.contains("trades-table__name")) {
                            System.out.println("название " + returnListName(element));
                        }
    ...
    public String returnListName(Element element) {
        String name = "";
        try {
            Element elementName = element.selectFirst(".trades-table__name");
            String strElementName = elementName.toString();
    ...
    public String getBotUsername() {
        return "@smart_lab_miha_bot";
    }

    @Override
    public String getBotToken() {
        return "8064302510:AAHVPIAneI1hp9-gusY6O_RnQxfC-efKUPE";
    }
}
